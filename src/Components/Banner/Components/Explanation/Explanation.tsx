...
class Explanation extends React.Component {
    ...
    render(): JSX.Element {
        ...
        const services = [MusicIdentifier.AppleMusic, MusicIdentifier.Spotify, MusicIdentifier.Pandora, MusicIdentifier.Tidal];

        const firstIdentifier = services[Math.floor(Math.random() * services.length)]

        const remainingServices = services.filter(service => service !== firstIdentifier);

        const secondIdentifier = remainingServices[Math.floor(Math.random() * remainingServices.length)];
            ...
            <div className="explanation-container">
                <div className="explanation-content">
                    <div className="artwork-container">
                        {elementForService(firstIdentifier)}
                        <div className="arrow">
                        ...
                        {elementForService(secondIdentifier)}
                    </div>
