                ...
                <div className="feature-list-section-content">
                    <div className="feature-grid">
                        <div className="feature-row">
                            <Feature name="Open Any Song, Anywhere" description={<p>Convusic supports many of the most popular services including Apple Music, Amazon Music, Deezer, Pandora, Spotify, Tidal, and YouTube Music. <a href="https://youtu.be/Z0-AWHiuo6s">See it in action.</a></p>} icon={FeatureIcon.Artist} />
                            <Feature name="Simple & Instant" description={<p>Enable Convusic and forget about it. Any music streaming link will automatically open in your app of choice. No interaction required.</p>} icon={FeatureIcon.Puzzle} />
                        </div>
                        <div className="feature-row">
