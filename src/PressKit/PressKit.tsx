        ...
        return(
            <div className="press-kit-container">
                <div className="press-kit-content">
                    ...
                    <p>Convusic is a Safari Extension that automatically redirects music streaming links from Apple Music, Amazon Music, Pandora, Spotify, Tidal, or YouTube Music to your app of choice. Tell us which app you use in the settings menu, and links from all other services will automatically open in that app instead. Convusic is available on the App Store for $0.99, and works on iOS 15 and macOS Monterey.</p>
